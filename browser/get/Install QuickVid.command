#!/bin/bash
# ============================================================================
# OCHA QuickVid — one-time INSTALLER for Mac (downloaded from the QuickVid page).
#
...
#   1. Download QuickVid into a system folder you never need to touch
...
#   3. Start the engine and open QuickVid in your browser.
#
# Running me again later = UPDATE QuickVid (your setup is kept, so it's quick).
# ============================================================================
set -e
